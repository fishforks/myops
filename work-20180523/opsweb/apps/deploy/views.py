...
class BuildView(LoginRequiredMixin, PaginationMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        test_jobs = jenkins_server.get_jobs(view_name='test')
        dev_jobs = jenkins_server.get_jobs(view_name='dev')
        context['all_jobs'] = all_jobs
        context['test_jobs'] = test_jobs
        context['dev_jobs'] = dev_jobs
        return context
    ...
    def post(self, request):
        ...
        return HttpResponseRedirect(reverse('deploy:console',kwargs={"jobname":jobname,"jobnumber":jobnumber}))
...
class Jenkins_console_out_view(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        self.jobname =  kwargs.get('jobname')
        self.jobnumber =  kwargs.get('jobnumber')
